...
| `docs/research/reward-design/Z1_IMPULSE_CAT_P02_BRIDGE_CROSS_MODEL_REVIEWS.md` | Post-bridge independent-review provenance and adjudication; pending until the separately controlled one-attempt-per-model consultation phase |
