...
| `docs/results/2026-08-17_z1_impulse_diag90_500_evaluation.md` | Banked one-training-seed result: lower J3 impulse exposure and retained task utility, but higher true velocity pressure makes the verdict redistribution/trade-off, not clean enforcement |
...
- 2026-08-17 — the completed 500-iteration diagnostic pair was evaluated on one fixed and three matched stochastic populations. Active impulse CaT reduced J3 diagnostic violation risk and p95/p99 utilization while retaining 100% task success, but true 500 Hz velocity-limit violation risk increased in every stochastic replica; verdict: redistribution/trade-off, not clean enforcement. Complete-event dose remains blocked by native terminal censoring (`docs/results/2026-08-17_z1_impulse_diag90_500_evaluation.md`)
