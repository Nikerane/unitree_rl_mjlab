...
| `docs/superpowers/specs/2026-08-18-z1-impulse-cat-thesis-campaign-design.md` | Simplified design: optional contact sensitivity, one provisional-cap `p=0.2` bridge with native impulse/velocity/utility gates, then independent seeds only after a pass; design only |
