...
| `docs/results/2026-08-18_z1_impulse_cat_dose_curve.md` | Current dose result: p=.1 is too weak; p=.3 is not monotonically better; p=.2 is the strongest tested policy instance but not a formal PASS under the strict every-population gate |
...
- 2026-08-18 — the compact p=.1/.2/.3 dose evaluation supersedes the earlier p=.2 formal-PASS interpretation without altering its historical record. Under identical declared population/RNG identities, one control environment crossed the contact/termination boundary across A100 executions: p=.2 now passes/fails/passes and therefore fails the strict every-population gate by 0.0001171875 in one CI-high. p=.1 is too weak; p=.3 is not monotonically better; p=.2 is the strongest tested policy instance but not a formal PASS. Independent training-seed confirmation is the bounded next question, not an optimal-dose claim (`docs/results/2026-08-18_z1_impulse_cat_dose_curve.md`)
