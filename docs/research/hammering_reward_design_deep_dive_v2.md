> ⚠️ **DATED RESEARCH RECORD** (2026-05-29 deep dive) — kept for provenance.
...
> `[E3]` inherited from the prior project corpus (`reward-design/LITERATURE.md`) — carries that corpus's verification *and its flags* (one prior fabrication, three preprint-venue ambiguities).
...
**Direct hammering / striking RL & IL literature (added 2026-05-29 via a deep external sweep; full annotations + the wider field map in [`hammering_literature_notes.md`](reward-design/LITERATURE.md) §2.6–2.7):**
...
**Inherited from prior corpus `[E3]` (see `reward-design/LITERATURE.md`; carries prior flags):**
