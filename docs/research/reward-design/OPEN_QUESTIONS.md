...
**HISTORICAL RESULT (2026-06-17, real claw-hammer — grasp #10, superseded
heavier gripper-era hammer; supersedes the box-hammer figures above):** The
current L6 asset does **not** use this mass configuration: it assigns **0.2 kg to
the entire rigid hammer body** (head and handle together), plus a separate
**0.045 kg fixture**. The measurements below remain provenance for the 2026-06-17
configuration and must not be reused as current-mass calibration data.
