...
>
> **Current-mass correction (2026-08-06):** this record describes a superseded
> heavier gripper-era configuration. The live L6 asset assigns **0.2 kg to the
> complete rigid hammer body**, not to a separately modeled head, and **0.045 kg**
> to the printed fixture. Historical measurements below have not been relabeled as
> current-mass results.
...
- Their mass (0.048 kg) is a manipulation-toy weight → this historical plan
  overrode it with a heavier head-dominated gripper-era model. That choice is now
  superseded: the current L6 asset assigns **0.2 kg to the complete rigid hammer
  body** (head and handle are not separately massed), plus a separate **0.045 kg
  fixture**.
